...
void loop() {
  ...
  push(accData[0], dataSize);
  push(accData[1], dataSize);
  push(accData[2], dataSize);

  accData[0][dataSize - 1] = accX - 500.00;
  accData[1][dataSize - 1] = accY + 1528.00;
  accData[2][dataSize - 1] = accZ - 17040.00;
  
  Serial.print(accX - 500.00); Serial.print("\t");
  //Serial.print(accY + 1528.00); Serial.print("\t");
  //Serial.print(accZ - 17040.00); Serial.print("\t");

  Serial.print(accData[0][dataSize-1]); Serial.print("\t");
  Serial.print(mean(accData[0], 100));
